                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, collectionRepository
                                    ...
                                    status: Collection_1.CollectionStatus.PUBLISH,
                                })
                                    .getRawOne()];
                        case 1:
                            collection = _b.sent();
                            ...
                            return [4 /*yield*/, filesRepository
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, agentRepo.findOne({
                                where: { id: (_a = questionnaries === null || questionnaries === void 0 ? void 0 : questionnaries.createdBy) === null || _a === void 0 ? void 0 : _a.id },
                            })];
                    case 2:
                        userDetails = _b.sent();
                        renderData = {
