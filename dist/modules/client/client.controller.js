...
var ClientController = /** @class */ (function () {
    function ClientController() {
        ...
        this.getCollectionByUrl = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.clientService.getCollectionByUrl(req.body)];
                    case 1:
                        result = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (result.code === 200) {
                            ...
                            return [2 /*return*/, res.status(result.code).json(result.error)];
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        error_4 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, this.clientService.getClientQuestionnaries(id)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, res.status(result.code).json(result.result)];
                    case 2:
