...
var BillingController = /** @class */ (function () {
  function BillingController() {
    var _this = this;
    this.clientService = new billing_service_1.BillingService();
    this.initiateTransaction = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        case 0:
          ...
          return [4 /*yield*/, this.clientService.initiateTransaction(userDetails, req.body)];
        case 1:
          result = _a.sent();
