...
var DashboardController = /** @class */ (function () {
    function DashboardController() {
        ...
        this.getSummary = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.dashboardService.getSummary(req.user)];
                    case 1:
                        result = _a.sent();
        ...
        this.upcomingBookings = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var date, result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        date = req.query.date;
                        return [4 /*yield*/, this.dashboardService.upcomingBookings(req.user, date)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, res.status(result.code).json(result)];
                    case 2:
