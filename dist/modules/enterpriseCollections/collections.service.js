  ...
  function CollectionService() {
    ...
    this.createCollection = function (body, userDetails) { return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        case 0:
          _a.trys.push([0, 4, , 5]);
          collectionRepository = db_config_1.AppDataSource.getRepository(enterpriseCollections_1.default);
          designRepo = db_config_1.AppDataSource.getRepository(enterprisecollectionDesign_1.EnterpriseCollectionDesign);
    ...
    this.getCollections = function (userDetails, search, order, sort) { return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        case 0:
          _a.trys.push([0, 3, , 4]);
          collectionRepository = db_config_1.AppDataSource.getRepository(enterpriseCollections_1.default);
          return [4 /*yield*/, collectionRepository
            ...
            .where('collections.createdBy = :clientId', {
    ...
    this.getCollectionDesign = function (userDetails, id) { return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        case 0:
          ...
          collectionRepository = db_config_1.AppDataSource.getRepository(enterpriseCollections_1.default);
          designRepo = db_config_1.AppDataSource.getRepository(enterprisecollectionDesign_1.EnterpriseCollectionDesign);
          return [4 /*yield*/, collectionRepository.findOneBy({
            id: id,
            createdBy: userDetails.id,
          })];
        case 1:
    ...
    this.deleteCollection = function (userDetails, id) { return __awaiter(_this, void 0, void 0, function () {
      var collectionRepository, fileRepo, collection, files, _i, files_1, file, clientSpace, error_6;
      return __generator(this, function (_a) {
        switch (_a.label) {
        case 0:
          _a.trys.push([0, 5, , 6]);
    ...
    this.deleteFiles = function (userDetails, id, ids) { return __awaiter(_this, void 0, void 0, function () {
      var collectionRepository, fileRepo, collection, idsArr, queryOptions, files, _i, files_2, file, filesToBeDeleted, clientSpace, error_7;
      return __generator(this, function (_a) {
        switch (_a.label) {
        case 0:
          _a.trys.push([0, 5, , 6]);
    ...
    this.updateCollection = function (params, body, userDetails) { return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        case 0:
          ...
          tagRepo = db_config_1.AppDataSource.getRepository(enterpriseCollectionTags_1.EnterpriseCollectionTags);
    ...
    this.uploadFiles = function (params, body, userDetails) { return __awaiter(_this, void 0, void 0, function () {
      var collectioRepo, fileRepo, collection, collectionFiles, fileNamesArr, files, filesUploadArr, compressedCollectoinPhoto, _i, files_4, file, existFile, compressedKey, reponse, clientSpace, error_13;
      return __generator(this, function (_a) {
        switch (_a.label) {
        case 0:
