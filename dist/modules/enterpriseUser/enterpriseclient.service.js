...
exports.EnterpriseClientService = void 0;
...
var EnterpriseClientService = /** @class */ (function () {
    function EnterpriseClientService() {
        this.passWordDecrypt = new passwordDecryptor_1.PasswordDecryptor();
    }
    EnterpriseClientService.prototype.enterpriseLogin = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var enterPriseClientRepo, agentSettingsRepo, enterPriseClient, passwordCheck, userObj, error_1;
    ...
    EnterpriseClientService.prototype.enterpriseRegister = function (enterPriseAgentObjInfo) {
        return __awaiter(this, void 0, void 0, function () {
            var enterPriseClientRepo, agentSettingRepo, enterpricesettingsRepo, existingAgent, encryptedPassword, enterPriseClient, enterPriseClientCreated, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        if (enterPriseAgentObjInfo.confirmPassword !==
    ...
    EnterpriseClientService.prototype.getEnterpriseRemaningBalance = function (userDetails) {
        return __awaiter(this, void 0, void 0, function () {
            var agentSettingsRepo, agentSettings, dataToSend, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    EnterpriseClientService.prototype.generateEnterpriseSettings = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var enterpriseSettingRepo, enterpriseClientRepo, enterPriseSetting, client, enterPriseSettingCreate, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
    ...
    return EnterpriseClientService;
}());
exports.EnterpriseClientService = EnterpriseClientService;
//# sourceMappingURL=enterpriseclient.service.js.map