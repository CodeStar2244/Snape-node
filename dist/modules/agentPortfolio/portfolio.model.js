...
exports.AddVideoLink = exports.UploadFilesModel = exports.PortfolioDesignModel = exports.UpdatePortfolioModel = exports.PortfolioGetModel = void 0;
...
var AddVideoLink = /** @class */ (function (_super) {
    __extends(AddVideoLink, _super);
    function AddVideoLink(body, params) {
        var _this = _super.call(this) || this;
        _this.url = body.url;
        return _this;
    }
    __decorate([
        (0, class_validator_1.IsNotEmpty)(),
        __metadata("design:type", String)
    ], AddVideoLink.prototype, "url", void 0);
    return AddVideoLink;
}(model_1.Model));
