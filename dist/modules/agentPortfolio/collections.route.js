...
var collectoinController = new portfolio_controller_1.CollectoinController();
...
router.get(routes_1.COLLECTION_ROUTES.GET_COLLECTIONS, v.validate(collections_model_1.CollectionGetModel), collectoinController.getCollections);
