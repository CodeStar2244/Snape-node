...
var portFolioVideosLink_1 = __importDefault(require("../../entities/portFolioVideosLink"));
var EnterpriseAgentsService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, enterpriseAgentFavouriteRepo
                    ...
                    case 1:
                        ...
                        agentQuery = agentRepo
                            .createQueryBuilder("agent")
                            .leftJoin("tblimages", "images", "agent.id = images.entityid AND entitytype = 'agent'")
                            .leftJoin("tblagentmediacategoriesmapping", "mediamapping", "agent.id = mediamapping.agentId")
                            .select("agent.id", "id")
                        ...
                        if (query.speciality) {
                            agentQuery.andWhere("agent.speciality = :speciality", {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        offset = +queryObj.page * +queryObj.limit;
                        limit = queryObj.limit;
                        favouriteAgentsQuery = enterpriseAgentFavouriteRepo
                            .createQueryBuilder("fav")
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        agentQuery = agentCategoriesRepo
                            .createQueryBuilder("mediamapping")
    ...
    EnterpriseAgentsService.prototype.getMediaCategories = function (userDetails) {
        return __awaiter(this, void 0, void 0, function () {
            var mediaCategoriesRepo, dataToSend, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    EnterpriseAgentsService.prototype.getAgentPortfolio = function (params, userDetails) {
        return __awaiter(this, void 0, void 0, function () {
            var agentId, agentRepo, agentPortFolioRepo, portFolioFilesRepo, agent, agentPortfolio, portFolioFiles, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
    ...
    EnterpriseAgentsService.prototype.getAgenVideos = function (params, userDetails) {
        return __awaiter(this, void 0, void 0, function () {
            var agentId, agentRepo, agentPortFolioRepo, portFolioVideosRepo, agent, agentPortfolio, portFolioFiles, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        agentRepo = db_config_1.AppDataSource.getRepository(Tblagent_1.Tblagent);
                        agentPortFolioRepo = db_config_1.AppDataSource.getRepository(Portfolio_1.default);
                        portFolioVideosRepo = db_config_1.AppDataSource.getRepository(portFolioVideosLink_1.default);
                        return [4 /*yield*/, agentRepo.findOne({ where: { id: agentId } })];
                    case 1:
                        agent = _a.sent();
                        if (!agent) {
                    ...
                    case 2:
                        agentPortfolio = _a.sent();
                        return [4 /*yield*/, portFolioVideosRepo.find({
                                where: {
                                    portfolio: { id: agentPortfolio.id },
                                },
                                select: {
    ...
    EnterpriseAgentsService.prototype.getAgentReviews = function (params, userDetails) {
        return __awaiter(this, void 0, void 0, function () {
            var agentId, bookingRepo, agentRepo, agent, bookings, error_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    EnterpriseAgentsService.prototype.addRemoveFavourite = function (params, userDetails, agentId) {
        return __awaiter(this, void 0, void 0, function () {
            var agentRepo, enterpriseRepo, enterpriseAgentFavouriteRepo, agent, enterpriseClient, enterpriseAgentFavourite, enterpriseAgentFavouriteEntry, error_10;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        agent = _a.sent();
                        return [4 /*yield*/, enterpriseRepo.findOne({
