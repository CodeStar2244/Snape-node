...
var AWSS3 = /** @class */ (function () {
    function AWSS3() {
        ...
        this.getS3File = function (key) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.getZipStream = function (collection, files) {
            try {
                return s3_zip_1.default.archive({ s3: _this.s3, bucket: process.env.S3_BUCKET_NAME }, collection, files);
            }
            catch (error) {
