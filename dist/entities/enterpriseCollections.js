...
var EnterpriseCollections = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.ManyToMany)(function () { return enterpriseCollectionTags_1.EnterpriseCollectionTags; }, function (tags) { return tags.id; }, { cascade: true }),
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return enterPriseClient_1.EnterPriseClient; }, function (client) { return client.id; }, { onDelete: "CASCADE" }),
