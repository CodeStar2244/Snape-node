...
exports.latestmigration1681640008873 = void 0;
var latestmigration1681640008873 = /** @class */ (function () {
    function latestmigration1681640008873() {
        this.name = 'latestmigration1681640008873';
    }
    latestmigration1681640008873.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE \"agentsettings\" ADD \"totalStorage\" double precision NOT NULL DEFAULT '3072'")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    latestmigration1681640008873.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 11:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"agentsettings\" DROP COLUMN \"totalStorage\"")];
                    case 12:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return latestmigration1681640008873;
}());
exports.latestmigration1681640008873 = latestmigration1681640008873;
//# sourceMappingURL=1681640008873-latestmigration.js.map