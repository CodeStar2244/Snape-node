...
exports.Latestmigration1699099469172 = void 0;
var Latestmigration1699099469172 = /** @class */ (function () {
    function Latestmigration1699099469172() {
        this.name = 'Latestmigration1699099469172';
    }
    Latestmigration1699099469172.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE \"plans\" ADD \"storageInPlan\" integer NOT NULL DEFAULT '3072'")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Latestmigration1699099469172.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"plans\" DROP COLUMN \"storageInPlan\"")];
                    case 10:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return Latestmigration1699099469172;
}());
exports.Latestmigration1699099469172 = Latestmigration1699099469172;
//# sourceMappingURL=1699099469172-latestmigration.js.map