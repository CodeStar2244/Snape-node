...
exports.latestmigration1681561457924 = void 0;
var latestmigration1681561457924 = /** @class */ (function () {
    function latestmigration1681561457924() {
        this.name = 'latestmigration1681561457924';
    }
    latestmigration1681561457924.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE \"files\" ALTER COLUMN \"key\" DROP DEFAULT")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"files\" DROP COLUMN \"size\"")];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"files\" ADD \"size\" double precision NOT NULL DEFAULT '0'")];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    latestmigration1681561457924.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"files\" ADD \"size\" integer NOT NULL")];
                    case 11:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"files\" ALTER COLUMN \"key\" SET DEFAULT 'test'")];
                    case 12:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return latestmigration1681561457924;
}());
exports.latestmigration1681561457924 = latestmigration1681561457924;
//# sourceMappingURL=1681561457924-latestmigration.js.map