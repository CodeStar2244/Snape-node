...
exports.Latestmigration1702045488138 = void 0;
var Latestmigration1702045488138 = /** @class */ (function () {
    function Latestmigration1702045488138() {
        this.name = 'Latestmigration1702045488138';
    }
    Latestmigration1702045488138.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE \"plans\" DROP COLUMN \"code\"")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Latestmigration1702045488138.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"plans\" ADD \"code\" character varying NOT NULL")];
                    case 10:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return Latestmigration1702045488138;
}());
exports.Latestmigration1702045488138 = Latestmigration1702045488138;
//# sourceMappingURL=1702045488138-latestmigration.js.map