...
exports.latestmigration1688897812669 = void 0;
var latestmigration1688897812669 = /** @class */ (function () {
  function latestmigration1688897812669() {
    this.name = 'latestmigration1688897812669';
  }
  latestmigration1688897812669.prototype.up = function (queryRunner) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
        case 0: return [4 /*yield*/, queryRunner.query('CREATE TABLE "studioclient" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying(30), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "agentId" integer, CONSTRAINT "UQ_ab7ca9dab154b11866186c340ee" UNIQUE ("phone"), CONSTRAINT "PK_9a45cb658a0b305fb99627b0c31" PRIMARY KEY ("id"))')];
        case 1:
          _a.sent();
          return [4 /*yield*/, queryRunner.query('ALTER TABLE "studioclient" ADD CONSTRAINT "FK_4c9146aabc064aff4bdd75738bf" FOREIGN KEY ("agentId") REFERENCES "tblagent"("id") ON DELETE CASCADE ON UPDATE NO ACTION')];
        case 2:
          _a.sent();
          return [2 /*return*/];
        }
  ...
  latestmigration1688897812669.prototype.down = function (queryRunner) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
        case 0: return [4 /*yield*/, queryRunner.query('ALTER TABLE "studioclient" DROP CONSTRAINT "FK_4c9146aabc064aff4bdd75738bf"')];
        case 1:
          _a.sent();
        ...
        case 10:
          _a.sent();
          return [4 /*yield*/, queryRunner.query('DROP TABLE "studioclient"')];
        case 11:
          _a.sent();
          return [2 /*return*/];
        }
  ...
  return latestmigration1688897812669;
}());
exports.latestmigration1688897812669 = latestmigration1688897812669;
//# sourceMappingURL=1688897812669-latestmigration.js.map