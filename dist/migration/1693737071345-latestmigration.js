...
exports.Latestmigration1693737071345 = void 0;
var Latestmigration1693737071345 = /** @class */ (function () {
    function Latestmigration1693737071345() {
        this.name = "Latestmigration1693737071345";
    }
    Latestmigration1693737071345.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE \"portFolioVideoLinks\" ALTER COLUMN \"url\" DROP NOT NULL")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Latestmigration1693737071345.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"portFolioVideoLinks\" ALTER COLUMN \"url\" SET NOT NULL")];
                    case 10:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return Latestmigration1693737071345;
}());
exports.Latestmigration1693737071345 = Latestmigration1693737071345;
//# sourceMappingURL=1693737071345-latestmigration.js.map