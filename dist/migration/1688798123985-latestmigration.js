...
exports.latestmigration1688798123985 = void 0;
var latestmigration1688798123985 = /** @class */ (function () {
  function latestmigration1688798123985() {
    this.name = 'latestmigration1688798123985';
  }
  latestmigration1688798123985.prototype.up = function (queryRunner) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
        case 0: return [4 /*yield*/, queryRunner.query('CREATE TABLE "enterpriseAgentFavourite" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_1f993f202e4688f7e4ca08717c2" PRIMARY KEY ("id"))')];
        case 1:
          _a.sent();
          return [2 /*return*/];
        }
  ...
  latestmigration1688798123985.prototype.down = function (queryRunner) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
        ...
        case 9:
          _a.sent();
          return [4 /*yield*/, queryRunner.query('DROP TABLE "enterpriseAgentFavourite"')];
        case 10:
          _a.sent();
          return [2 /*return*/];
        }
  ...
  return latestmigration1688798123985;
}());
exports.latestmigration1688798123985 = latestmigration1688798123985;
//# sourceMappingURL=1688798123985-latestmigration.js.map