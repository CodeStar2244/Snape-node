...
exports.latestmigration1680976300829 = void 0;
var latestmigration1680976300829 = /** @class */ (function () {
    function latestmigration1680976300829() {
        this.name = 'latestmigration1680976300829';
    }
    latestmigration1680976300829.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("CREATE TABLE \"plans\" (\"id\" SERIAL NOT NULL, \"name\" character varying NOT NULL, \"code\" character varying NOT NULL, \"description\" character varying, \"amountPerMonth\" integer NOT NULL, \"createdAt\" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), \"updatedAt\" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT \"PK_3720521a81c7c24fe9b7202ba61\" PRIMARY KEY (\"id\"))")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"transactions\" (\"id\" SERIAL NOT NULL, \"transactionId\" character varying NOT NULL, \"status\" character varying NOT NULL DEFAULT 'Pending', \"amount\" integer NOT NULL, \"referenceId\" character varying NOT NULL, \"createdAt\" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), \"updatedAt\" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), \"planId\" integer, \"agentId\" integer, CONSTRAINT \"PK_a219afd8dd77ed80f5a862f1db9\" PRIMARY KEY (\"id\"))")];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"transactions\" ADD CONSTRAINT \"FK_43771d706542ae6e309f3ff8bbb\" FOREIGN KEY (\"planId\") REFERENCES \"plans\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"transactions\" ADD CONSTRAINT \"FK_b7f013fd7dc39795d068db41293\" FOREIGN KEY (\"agentId\") REFERENCES \"tblagent\"(\"id\") ON DELETE CASCADE ON UPDATE NO ACTION")];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    latestmigration1680976300829.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE \"transactions\" DROP CONSTRAINT \"FK_b7f013fd7dc39795d068db41293\"")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"transactions\" DROP CONSTRAINT \"FK_43771d706542ae6e309f3ff8bbb\"")];
                    case 2:
                        _a.sent();
                    ...
                    case 12:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("DROP TABLE \"plans\"")];
                    case 13:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return latestmigration1680976300829;
}());
exports.latestmigration1680976300829 = latestmigration1680976300829;
//# sourceMappingURL=1680976300829-latestmigration.js.map