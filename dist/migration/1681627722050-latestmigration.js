...
exports.latestmigration1681627722050 = void 0;
var latestmigration1681627722050 = /** @class */ (function () {
    function latestmigration1681627722050() {
        this.name = 'latestmigration1681627722050';
    }
    latestmigration1681627722050.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE \"collections\" ALTER COLUMN \"size\" DROP NOT NULL")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    latestmigration1681627722050.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"collections\" ALTER COLUMN \"size\" SET NOT NULL")];
                    case 10:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return latestmigration1681627722050;
}());
exports.latestmigration1681627722050 = latestmigration1681627722050;
//# sourceMappingURL=1681627722050-latestmigration.js.map