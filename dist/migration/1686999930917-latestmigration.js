...
exports.latestmigration1686999930917 = void 0;
var latestmigration1686999930917 = /** @class */ (function () {
  function latestmigration1686999930917() {
    this.name = 'latestmigration1686999930917';
  }
  latestmigration1686999930917.prototype.up = function (queryRunner) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
        case 0: return [4 /*yield*/, queryRunner.query('CREATE TABLE "enterprisesettings" ("id" SERIAL NOT NULL, "storage" double precision DEFAULT \'0\', "assets" double precision DEFAULT \'0\', "totalStorage" double precision NOT NULL DEFAULT \'3072\', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "clientId" integer, CONSTRAINT "REL_260f1461d431d2b07a6140bba1" UNIQUE ("clientId"), CONSTRAINT "PK_a5532bc37b20c632e662a1fd306" PRIMARY KEY ("id"))')];
        case 1:
          _a.sent();
        ...
        case 3:
          _a.sent();
          return [4 /*yield*/, queryRunner.query('ALTER TABLE "enterprisesettings" ADD CONSTRAINT "FK_260f1461d431d2b07a6140bba18" FOREIGN KEY ("clientId") REFERENCES "enterPriseClient"("id") ON DELETE CASCADE ON UPDATE NO ACTION')];
        case 4:
          _a.sent();
          return [2 /*return*/];
        }
  ...
  latestmigration1686999930917.prototype.down = function (queryRunner) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
        case 0: return [4 /*yield*/, queryRunner.query('ALTER TABLE "enterprisesettings" DROP CONSTRAINT "FK_260f1461d431d2b07a6140bba18"')];
        case 1:
          _a.sent();
        ...
        case 12:
          _a.sent();
          return [4 /*yield*/, queryRunner.query('DROP TABLE "enterprisesettings"')];
        case 13:
          _a.sent();
          return [2 /*return*/];
        }
  ...
  return latestmigration1686999930917;
}());
exports.latestmigration1686999930917 = latestmigration1686999930917;
//# sourceMappingURL=1686999930917-latestmigration.js.map