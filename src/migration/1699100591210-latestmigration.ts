...
export class Latestmigration1699100591210 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "agentsettings" ADD "currentPlan" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "agentsettings" ADD CONSTRAINT "FK_a691d8c3995fac46c009cd1b7c4" FOREIGN KEY ("currentPlan") REFERENCES "plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "agentsettings" DROP CONSTRAINT "FK_a691d8c3995fac46c009cd1b7c4"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "agentsettings" DROP COLUMN "currentPlan"`,
    );
  }
}
