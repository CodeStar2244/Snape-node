...
export class latestmigration1681561457924 implements MigrationInterface {
    name = 'latestmigration1681561457924'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "files" ALTER COLUMN "key" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN "size"`);
        await queryRunner.query(`ALTER TABLE "files" ADD "size" double precision NOT NULL DEFAULT '0'`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "files" ALTER COLUMN "key" SET DEFAULT 'test'`);
    }
