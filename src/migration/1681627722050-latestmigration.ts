...
export class latestmigration1681627722050 implements MigrationInterface {
    name = 'latestmigration1681627722050'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "collections" ALTER COLUMN "size" DROP NOT NULL`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "collections" ALTER COLUMN "size" SET NOT NULL`);
    }
