...
export class latestmigration1690099458548 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "studioclient" ALTER COLUMN "profileUrl" SET DEFAULT 'https://snape-buckets.b-cdn.net/default/userprofile.png'`);
        await queryRunner.query(`ALTER TABLE "studiospeciality" ALTER COLUMN "imageUrl" SET DEFAULT 'https://snape-buckets.b-cdn.net/default/userprofile.png'`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "studiospeciality" ALTER COLUMN "imageUrl" SET DEFAULT 'default/special.png'`);
        await queryRunner.query(`ALTER TABLE "studioclient" ALTER COLUMN "profileUrl" SET DEFAULT 'default/userprofile.png'`);
    }
