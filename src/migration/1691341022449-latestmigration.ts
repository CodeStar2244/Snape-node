...
export class latestmigration1691341022449 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "enterpriseBooking" ADD "mediacategories" character varying(500) DEFAULT ''`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "enterpriseBooking" DROP COLUMN "mediacategories"`);
    }
