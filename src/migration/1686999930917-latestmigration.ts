...
export class latestmigration1686999930917 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "enterprisesettings" ADD CONSTRAINT "FK_260f1461d431d2b07a6140bba18" FOREIGN KEY ("clientId") REFERENCES "enterPriseClient"("id") ON DELETE CASCADE ON UPDATE NO ACTION',
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE "enterprisesettings" DROP CONSTRAINT "FK_260f1461d431d2b07a6140bba18"',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "CREATE TYPE \"public\".\"agentsettings_type_enum\" AS ENUM('ENTERPRISE', 'STUDIO')",
    );
    await queryRunner.query(
      'ALTER TABLE "agentsettings" ADD "type" "public"."agentsettings_type_enum" NOT NULL DEFAULT \'STUDIO\'',
    );
