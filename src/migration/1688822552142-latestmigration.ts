...
export class latestmigration1688822552142 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "files" ADD "compressedKey" character varying`);
        await queryRunner.query(`ALTER TABLE "files" ADD "compressedCdnUrl" character varying`);
        await queryRunner.query(`ALTER TABLE "files" ADD "compressedImageSize" double precision DEFAULT '0'`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN "compressedImageSize"`);
        await queryRunner.query(`ALTER TABLE "files" DROP COLUMN "compressedCdnUrl"`);
