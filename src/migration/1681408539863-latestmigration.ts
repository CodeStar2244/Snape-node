...
export class latestmigration1681408539863 implements MigrationInterface {
    name = 'latestmigration1681408539863'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tblagent" ADD "totalDeviceAmount" integer DEFAULT '0'`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tblagent" DROP COLUMN "totalDeviceAmount"`);
    }
