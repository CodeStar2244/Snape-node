...
export class latestmigration1688829949378 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE "enterprisefiles" ADD "compressedKey" character varying',
    );
    await queryRunner.query(
      'ALTER TABLE "enterprisefiles" ADD "compressedCdnUrl" character varying',
    );
    await queryRunner.query(
      'ALTER TABLE "enterprisefiles" ADD "compressedImageSize" double precision DEFAULT \'0\'',
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "enterprisefiles" DROP COLUMN "compressedImageSize"',
    );
    await queryRunner.query(
      'ALTER TABLE "enterprisefiles" DROP COLUMN "compressedCdnUrl"',
    );
    await queryRunner.query(
      'ALTER TABLE "enterprisefiles" DROP COLUMN "compressedKey"',
    );
  }
}
