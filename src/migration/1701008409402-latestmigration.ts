...
export class Latestmigration1701008409402 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tblagent" ADD "location" character varying(400)`,
    );
    await queryRunner.query(
      `ALTER TABLE "tblagent" ADD "businessName" character varying(400)`,
    );
    await queryRunner.query(
      `ALTER TABLE "tblagent" ADD "timezone" character varying(400)`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tblagent" DROP COLUMN "businessName"`,
    );
