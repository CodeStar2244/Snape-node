...
export class CollectoinController {
  ...
  public getCollectionByID = async (req, res) => {
    try {
      const result = await this.collectionService.getCollectionByID(
        req.user,
        req.params.id,
      );
      return res.status(result.code).json(result);
  ...
  public getCollectionDesign = async (req, res) => {
    try {
      const result = await this.collectionService.getCollectionDesign(
        req.user,
        req.params.id,
      );
      return res.status(result.code).json(result);
  ...
  public getCollectionFiles = async (req, res) => {
    try {
      ...
      const result = await this.collectionService.getCollectionFiles(
        req.user,
        req.params.id,
        search,
        sort,
  ...
  public getCollectionFilesName = async (req, res) => {
    try {
      const result = await this.collectionService.getCollectionFilesName(
        req.user,
        req.params.id,
      );
      return res.status(result.code).json(result);
  ...
  public collectionDesign = async (req, res) => {
    try {
      const result = await this.collectionService.collectionDesign(
        req.params,
        req.body,
        req.user,
      );
  ...
  public changeCoverPhoto = async (req, res) => {
    try {
      const result = await this.collectionService.changeCoverPhoto(
        req.params,
        req.body,
        req.user,
      );
  ...
  public deleteFiles = async (req, res) => {
    try {
      const { ids } = req.body;
      const result = await this.collectionService.deleteFiles(
        req.user,
        req.params.id,
        ids,
      );
  ...
  public filesUpload = async (req, res) => {
    try {
      const result = await this.collectionService.uploadFiles(
        req.params,
        req.body,
        req.user,
      );
