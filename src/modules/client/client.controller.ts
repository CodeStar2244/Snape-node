...
export class ClientController {
  ...
  public downloadFile = async (req, res: Response) => {
    try {
      const result = await this.clientService.downloadFile(
        req.user,
        req.params.id,
        req.body,
        res,
  ...
  public downloadCollection = async (req, res: Response) => {
    try {
      const result = await this.clientService.downloadCollection(
        req.user,
        req.params.id,
        req.body,
        res,
  ...
  public downloadPinCheck = async (req, res: Response) => {
    try {
      const result = await this.clientService.downloadPinCheck(
        req.user,
        req.params.id,
        req.body,
        res,
  ...
  public downloadFilePinCheck = async (req, res: Response) => {
    try {
      const result = await this.clientService.downloadFilePinCheck(
        req.user,
        req.params.id,
        req.body,
        res,
  ...
  public submitClientQuestionnaries = async (req, res: Response) => {
    try {
      ...
      const result = await this.clientService.submitClientQuestionnaries(
        id,
        params,
      );
      return res.status(result.code).json(result.result);
