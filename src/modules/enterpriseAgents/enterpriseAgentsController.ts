...
export class EnterpriseAgentsController{
    ...
    public getAgentPortfolio = async (req:any,res:Response)=>{
        try {
            const userDetails = req.user;
            const result = await this.enterpriseAgentsService.getAgentPortfolio(req.params,userDetails);
            return res.status(result.code).json(result);
    ...
    public getAgentReviews = async (req:any,res:Response)=>{
        try {
            const userDetails = req.user;
            const result = await this.enterpriseAgentsService.getAgentReviews(req.params,userDetails);
            return res.status(result.code).json(result);
